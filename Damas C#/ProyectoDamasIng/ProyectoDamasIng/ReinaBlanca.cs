...
{
    class ReinaBlanca:FichaBlanca
    {
        public ReinaBlanca(int fila, int columna) : base(fila, columna)
        {
        ...
        public List<Ficha> PosiblesMov()
        {
            ...
            {
                this.posiblesMov.Add(new ReinaBlanca(this.fila - 1, this.columna + 1));
            }
        ...
        public List<Ficha> PosiblesComer()
        {
            ...
            {
                this.posiblesComer.Add(new ReinaBlanca(this.fila - 2, this.columna + 2));
            }
