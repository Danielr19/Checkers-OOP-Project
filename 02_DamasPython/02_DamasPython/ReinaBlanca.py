# -*- coding: utf-8 -*-
"""
Created on Sun Jul 12 09:05:03 2020
...
class ReinaBlanca(Ficha):
    def __init__(self,fila,columna):
        super().__init__(fila,columna,"breina",'blanca')
    ...
    def PosiblesMov(self):
            ...
            if self.__fila != 0 and self.__columna == 0:
                ...
                self.__posiblesMov.append(ReinaBlanca(self.__fila - 1, self.__columna + 1))
    ...
    def PosiblesComer(self):
            ...
            if self.__fila > 1 and self.__columna < 2:
                ...
                self.__posiblesComer.append(ReinaBlanca(self.__fila - 2, self.__columna + 2))
